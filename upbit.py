...
if __name__=='__main__':
    ...
    #supertrend cautious buy/sell order every 2 hours
    schedule.every(2).hours.do(execute_supertrend_cautious_buy, exchange, doge)
    schedule.every(2).hours.do(execute_supertrend_cautious_buy, exchange, xrp)
    schedule.every(2).hours.do(execute_supertrend_cautious_buy, exchange, sol)
    schedule.every(2).hours.do(execute_supertrend_cautious_buy, exchange, btc)
    schedule.every(2).hours.do(execute_supertrend_cautious_buy, exchange, eth)
    schedule.every(2).hours.do(execute_supertrend_cautious_sell, exchange, doge)
    schedule.every(2).hours.do(execute_supertrend_cautious_sell, exchange, xrp)
    schedule.every(2).hours.do(execute_supertrend_cautious_sell, exchange, sol)
    schedule.every(2).hours.do(execute_supertrend_cautious_sell, exchange, btc)
    schedule.every(2).hours.do(execute_supertrend_cautious_sell, exchange, eth)
